...
public class TicketBookingController {
	...
	@GetMapping("/search")
	public ResponseEntity<List<AddAirLineEntity>> searchFlights(@RequestParam String from, @RequestParam String to,
			@RequestParam String departureDate, @RequestParam String seatType) {
		logger.info("Inside searchFlights method");
		List<AddAirLineEntity> res = ticketBookingService.searchFlights(from, to, departureDate, seatType);
